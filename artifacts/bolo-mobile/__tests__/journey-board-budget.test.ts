...
describe('the carved board leaves room for what it has to say', () => {
  ...
  it('has a panel at least as tall as its content needs, at every width', () => {
  ...
  it('would have failed on the old mobile PC_H, which is the point', () => {
  ...
  it('gives the pediment its aspect and nothing more', () => {

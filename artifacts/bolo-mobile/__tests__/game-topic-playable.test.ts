...
describe('a topic is offered on what it can PLAY, not on what it holds', () => {
  ...
  it('counts what the journey has opened, not what the topic contains', () => {
  ...
  it('falls back to the total when the server has no opinion', () => {
  ...
  it('is what decides the grey, at the floor each game asks for', () => {

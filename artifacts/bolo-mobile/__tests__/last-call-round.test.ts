// THE LAST CALL ROUND, pinned without a microphone, a clock or a screen.
//
// Owner brief, 2026-09-14 (slice 1): a failing band re-queues the passenger at
// the end; three misses end the round; consecutive hits shorten the timer; a
// 'nocatch' band or a scoring timeout re-asks with no strike; the timer pauses
// while scoring; the round ends when everyone boards.
//

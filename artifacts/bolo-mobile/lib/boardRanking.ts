/**
 * THE BOARD'S ARITHMETIC, PURE (build 22, the owner's Leaderboard mockup).
 * Ranking by either metric, the gap to the row above, the weekly race clock
 * and what Bolo says about your standing. No React, no query: both the Feed
 * tab and the standalone Leaderboard screen call these, which is how the two
 * boards stopped being able to disagree.
 *
 * Web twin, when it gets the same board: gujarati-coach/src/lib/boardRanking.ts.
 */

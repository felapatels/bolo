  ...
  return (
    <div className="min-h-[100dvh] bg-background flex flex-col">
      ...
      <main className="flex-1 p-6 space-y-6">
        <div className="bg-white rounded-3xl p-8 border-2 border-border shadow-sm flex flex-col items-center">
  ...
  return (
    <div className="min-h-[100dvh] bg-background flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-8">
        <div className="bg-white rounded-[2rem] p-10 border border-card-border shadow-sm w-full max-w-sm">
          <BuildingMessage languageName={languageName} />
        </div>
      </div>
    </div>

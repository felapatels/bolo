...
4. **Hidden-nav locators.** At mobile width the desktop sidebar links are in the DOM but not visible; `page.locator("a", { hasText })` resolves to the hidden one and times out. Use `a:visible`.

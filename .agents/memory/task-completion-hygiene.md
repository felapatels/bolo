...
**Rule 2:** The completion validation runs every configured test workflow, and this project's suites fail at documented pre-existing baselines (api-server: 14 enumerated in CODEBASE-FACTS §8; web: account.test.tsx x6 + chat-error-banner.test.tsx x2). Validation therefore FAILS even for clean work.
